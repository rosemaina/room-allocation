...
class Dojo(object):
	...
	def add_person(self, last_name, first_name, person_type='fellow', wants_accomodation='N'):
		if type(last_name) != str and type(first_name) != str and type(person_type) != str:
			raise ValueError("input should be a string")

		else :
			_name = last_name.lower()
